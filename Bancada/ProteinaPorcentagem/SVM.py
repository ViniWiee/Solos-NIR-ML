...
parameters = {
    ...
    'svr__gamma': [1.0,10.0,100.0,1000.0,10000.0,],
    'svr__C': [1.0,10.0,100.0,1000.0,10000.0]
}
...
pd.DataFrame(cvlist).to_csv("CSV/cvresultsProteinaPorcentagem.csv", header=None, index=None)
